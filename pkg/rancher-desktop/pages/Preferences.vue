...
<!--
  To make the components easier, we wait for the preferences to load before
  rendering any of the contents.  Otherwise things can randomly break if the
  preferences are not loaded yet (which shows as an object with no properties).
-->
<template>
